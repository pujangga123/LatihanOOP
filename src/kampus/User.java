        ...
        try {
            ...
            if (!connection.isClosed()) {
                ...
                if (tipe.equals("DOSEN")) {
                    sql = "SELECT id, dosen.nama, users.tipe, users.status FROM users inner join dosen on nid=id where nid=?";
                } else {
                    sql = "SELECT id, mahasiswa.nama, users.tipe, users.status FROM users inner join mahasiswa on nim=id where nim=?";
                }
